...
- Optional multisig-lite shared access can require M-of-N co-approver signatures before the proxy prepares Ika approval data; missing quorum returns `needs-approval` progress such as `1/2` without exposing confidential numeric thresholds.
