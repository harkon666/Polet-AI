...
import { SimpleDemoTab } from '#/components/SimpleDemoTab'
import { TemporalKeyManager } from '#/components/TemporalKeyManager'
...
export function WalletDashboard() {
  ...
  return (
    <div className="space-y-6">
      ...
      {/* Tab content, legacy components copied into the canonical frontend.
          The pl-app-shell wrapper around this dashboard redefines legacy
