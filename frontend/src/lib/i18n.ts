...
export const COPY = {
  id: {
    ...
    policyBody: 'Jalur utama memakai ciphertext account official Encrypt dan transaksi policy registration. Masked witness hanya fallback dev eksplisit.',
    ...
    encryptExecutionRefsHelp: 'Source amount dan pending output ciphertext harus cocok dengan state wallet sebelum proxy menyiapkan payload.',
  ...
  en: {
    ...
    policyBody: 'Primary setup uses official Encrypt ciphertext accounts and a policy registration transaction. Masked witness is only an explicit dev fallback.',
    ...
    encryptEventAuthority: 'Event authority',
    encryptExecutionRefs: 'Official Encrypt execution refs',
    encryptExecutionRefsHelp: 'Source amount and pending output ciphertexts must match wallet state before the proxy prepares payloads.',
    encryptSourceAmountCiphertext: 'Source amount ciphertext',
