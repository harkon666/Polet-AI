...
export const COPY = {
  id: {
    ...
    policyBody: 'Masukkan batas USDC. Official Encrypt ciphertext refs tidak menjadi input user; refs hanya ditampilkan read-only saat wallet sudah punya policy Encrypt on-chain.',
    ...
    encryptPrealphaStatusHelp: 'Ciphertext refs official Encrypt masih pre-alpha dan hanya ditampilkan sebagai status teknis jika sudah ada di wallet. Jangan input data sensitif di pre-alpha.',
    ...
    confirmPolicy: 'Simpan policy confidential ke contract. Nilai privat akan disembunyikan setelah transaksi dikonfirmasi.',
  ...
  en: {
    ...
    policyBody: 'Enter USDC limits. Official Encrypt ciphertext refs are not user inputs; refs are shown read-only only when the wallet already has an on-chain Encrypt policy.',
    ...
    encryptPrealphaStatus: 'Encrypt pre-alpha',
    encryptPrealphaStatusHelp: 'Official Encrypt ciphertext refs are pre-alpha and shown as technical status only when already present on the wallet. Do not enter sensitive data in pre-alpha.',
    ...
    confirmPolicy: 'Save the confidential policy to the contract. Private values will be hidden after confirmation.',
