...
export const COPY = {
  id: {
    ...
    recoveryBody: 'Atur recovery authority untuk emergency access. Recovery bisa revoke compromised sessions, rotate shared Ika approvers, dan stage dWallet controller migration.',
    ...
    recoveryCompromisedSessions: 'Session keys to revoke',
    recoverySessionsPlaceholder: 'Satu session key public key per baris',
    ...
    recoveryNoSessions: 'Tidak ada compromised sessions',
    recoverySessionsCount: 'Sessions untuk revoke',
  ...
  en: {
    ...
    recoveryTitle: 'Recovery authority',
    recoveryBody: 'Set a recovery authority for emergency access. Recovery can revoke compromised sessions, rotate shared Ika approvers, and stage dWallet controller migration.',
    recoverySetAuthority: 'Sign & set recovery authority',
    recoveryRecoveryAuthority: 'Recovery authority address',
    recoveryPlaceholder: 'Enter recovery authority public key',
    recoveryRecoveryAccess: 'Sign & recover access',
    recoveryCompromisedSessions: 'Session keys to revoke',
    recoverySessionsPlaceholder: 'One session key public key per line',
    recoverySharedIkaThreshold: 'New shared Ika threshold',
    recoverySharedIkaApprovers: 'New shared Ika approvers',
    ...
    recoveryNoSessions: 'No compromised sessions',
    recoverySessionsCount: 'Sessions to revoke',
    ...
    confirmRecoveryAccess: 'Revoke compromised sessions, rotate shared Ika approvers, and stage dWallet migration. Owner or recovery authority must sign. Session count',
  },
} as const;
