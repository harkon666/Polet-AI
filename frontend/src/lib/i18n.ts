...
export const COPY = {
  id: {
    ...
    encryptGraphSubmitted: 'Graph policy official Encrypt sudah dikirim. Payload Jupiter/Ika ditekan sampai output executor terverifikasi.',
  ...
  en: {
    ...
    encryptGraphSubmitted: 'Official Encrypt policy graph submitted. Jupiter/Ika payloads stay suppressed until executor output is verified.',
