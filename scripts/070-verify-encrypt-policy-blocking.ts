#!/usr/bin/env bun
/**
 * 070-verify-encrypt-policy-blocking — Verify encrypted policy rules block on-chain
 *
 ...
 * 6. Create 25 USDC execution ciphertexts
 * 7. Execute graph - should BLOCK (25 > 20 daily cap)
 */
...
async function main() {
  console.log('=== 070: Verify Encrypt Policy On-Chain Blocking ===\n');
  ...
  // 6. Create 25 USDC execution ciphertexts
  console.log('\n6. Creating 25 USDC execution ciphertexts...');
  const execInputs = [
    { value: parseUsdcBaseUnits('25'), type: FHE_UINT64 },
  ...
  console.log('   Policy: maxPerRun=10 USDC, dailyCap=20 USDC, sourceAmount=25 USDC');
